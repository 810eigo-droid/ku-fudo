...
?>
<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>議事録・お知らせ｜じねんネットワーク</title><link rel="stylesheet" href="operations.css"></head><body><header><a href="./">じねんネットワーク</a><span>担当者のページ</span></header><nav><?php if($ready):?><a href="mail-center.php">メールでお知らせ</a><?php endif;?><a href="./">チャットへ戻る</a><?php if($board):?><a href="operations.php">議事録</a><?php endif;?><?php if($notice):?><a href="?tab=notice">お知らせ投稿</a><?php endif;?><?php if($admin):?><a href="?tab=editors">地区担当者の設定</a><?php endif;?></nav><main>
