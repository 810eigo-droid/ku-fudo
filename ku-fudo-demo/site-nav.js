...
const links=[['ku-fudo-demo/','トップページ'],['ku-fudo-demo/about.html','空不動先生について'],['ku-fudo-demo/membership.html','学びと実践・入会案内'],['ku-fudo-demo/meditation.html','瞑想の会'],['ku-fudo-chat/mypage.php','マイページ（記録・登録情報）'],['ku-fudo-chat/','チャット'],['ku-fudo-chat/?room=all#zoom-schedule','Zoom会議の予定'],['ku-fudo-demo/#curriculum','カリキュラム'],['ku-fudo-smartoon/','漫画：空不動先生の歩み'],['ku-fudo-demo/prayer-practice.html','初めての実践ガイド'],['ku-fudo-chat/redo.php','REDO MAIL'],['ku-fudo-chat/prayer.php','祈りの蓄積'],['ku-fudo-chat/?account=1#account','アカウント']];
